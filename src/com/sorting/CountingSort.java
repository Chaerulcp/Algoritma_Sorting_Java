...
public class CountingSort {
    ...
    public static void main(String[] args) {
        ...
        // print nilai sebelum counting sort
        System.out.print("Sebelum Di Counting : ");
        System.out.print("[");
        for (i = 0; i <= n - 1; i++) {
        ...
        // print sesudah counting sort
        System.out.print("Sesudah Di Counting : ");
        System.out.print("[");
        for (i = 0; i <= n - 1; i++) {
            System.out.print("  " + data[i]);
        }
